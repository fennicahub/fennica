...
description: "Statistics about the subject of the articles"
---
...
```{r}
#| label = "summarytitle-subject-topic",
#| echo = FALSE,
#| message = FALSE,
#| warning = FALSE,
#| fig.width = 8,
...
```{r}
#| label = "uniquetitles-subject-topic",
#| echo = FALSE,
#| message = FALSE,
#| warning = FALSE,
#| fig.width = 8,
