...
`r sum((df$multi_udk == FALSE), na.rm = TRUE)` single UDC entries (`r round(100 * mean(df$multi_udk == FALSE, na.omit = TRUE), 2)`%)

`r sum(df$multi_udk == TRUE, na.rm = TRUE)` multiple UDC entries (`r round(100 * mean(df$multi_udk == TRUE, na.omit = TRUE), 2)`%)
...
`r sum((df_19$multi_udk == FALSE), na.rm = TRUE)` single UDC entries (`r round(100 * mean(df_19$multi_udk == FALSE, na.omit = TRUE), 2)`%)

`r sum(df_19$multi_udk == TRUE, na.rm = TRUE)` multiple UDC entries (`r round(100 * mean(df_19$multi_udk == TRUE, na.omit = TRUE), 2)`%)
