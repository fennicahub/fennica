...
df_genre_008$converted_008_33 <- as.character(df_genre_008$converted_008_33)
s <- write_xtable(as.character(df_genre_008$converted_008_33), file_accepted, count = TRUE)
