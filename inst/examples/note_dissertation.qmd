---
title : "Note dissertation"
hide-description: false
description: "Statistics about the thesis which are present the articles"
---
...
```
```{r}
#| label = "source-note-dissertation",
#| include = FALSE,
#| eval = knit_bookdown
...
```{r}
#| label = "summarytitle-note-dissertation",
#| echo = FALSE,
#| message = FALSE,
#| warning = FALSE,
#| fig.width = 8,
...
```{r}
#| label = "uniquetitles-note-dissertation",
#| echo = FALSE,
#| message = FALSE,
#| warning = FALSE,
#| fig.width = 8,
