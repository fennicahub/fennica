...
-   [Unique accepted entries (1809-1917)](dataTable/data_table.html?path=../%60r%20file_accepted%60): `r length(unique(df_19[[field]]))`
-   [Unique discarded entries in original data (1809-1917)](dataTable/data_table.html?path=../%60r%20file_discarded_19%60) (excluding NA cases): `r as.vector(countLines(file_discarded_19) - 1)`
