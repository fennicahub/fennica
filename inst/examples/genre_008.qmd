...
#| echo = FALSE,
#| warning = FALSE,
# Join publication_decade from df_pubtime to df by _id
df$publication_decade <- df_pubtime$publication_decade[match(df$id, df_pubtime$id)]
...
#| echo = FALSE,
#| warning = FALSE,
# Join publication_decade from df_pubtime to df by id
df_19$publication_decade <- df_pubtime19$publication_decade[match(df_19$id, df_pubtime19$id)]
