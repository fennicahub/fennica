...
Polish publication place field: [publisher.R](https://github.com/fennicahub/fennica/blob/master/inst/examples/publication place.R)

Harmonize geospatial data function: [polish_place.R](https://github.com/fennicahub/fennica/blob/master/R/polish_place.R)

Render publication place field: [publisher.qmd](https://github.com/fennicahub/fennica/blob/master/inst/examples/publication place.qmd)
...
-   [Conversions from the original to the accepted place names](dataTable/data_table.html?path=../output.tables/publication_place_conversion_nontrivial.csv) <!-- * [Unit tests for place names](https://github.com/COMHIS/fennica/blob/master/inst/extdata/tests_place.csv) are automatically checked during package build -->
...
-   `r length(unique(str_trim(unlist(strsplit(as.character(df_19$publication_place), ";")))))` [unique publication places](dataTable/data_table.html?path=../output.tables/publication_place_accepted_19.csv); available for `r sum(!is.na(df_19$publication_place))` documents (`r round(100*mean(!is.na(df_19$publication_place)))`%).
...
-   `r length(readLines(paste0("output.tables/publication_place_discarded_19.csv"))) - 1` [discarded place names](dataTable/data_table.html?path=../output.tables/publication_place_discarded_19.csv)
