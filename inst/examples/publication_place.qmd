...
* `r length(unique(df_19$publication_country))` [unique publication countries](dataTable/data_table.html?path=../output.tables/publication_country_accepted_19.csv); available for `r sum(!is.na(df$publication_country))` documents (`r round(100*mean(!is.na(df_19$publication_country)))`%).
