...
* [Unique accepted entries](dataTable/data_table.html?path=../output.tables/subject_topic_accepted.csv): `r length(unique(df[[field]]))`
* [Unique discarded entries in original data](dataTable/data_table.html?path=../output.tables/subject_topic_discarded.csv) (excluding NA cases): `r as.vector(countLines(file_discarded) - 1)`
