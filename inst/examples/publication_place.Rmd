 ...
 * `r length(readLines(paste0("output.tables/publication_place_discarded.csv"))) - 1` [discarded place names](dataTable/data_table.html?path=../output.tables/publication_place_discarded.csv) These terms are potential place names but with a closer check have been explicitly rejected on the [synonyme list](output.tables/PublicationPlaceSynonymes.csv)
