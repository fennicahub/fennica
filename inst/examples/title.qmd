...
Polish title field: [title.R](https://github.com/fennicahub/fennica/blob/master/inst/examples/title.R)

Harmonize title metadata function: [polish_title.R](https://github.com/fennicahub/fennica/blob/master/R/polish_title.R)

Render title field: [title.qmd](https://github.com/fennicahub/fennica/blob/master/inst/examples/title.qmd)

## Complete Dataset Overview

-   [Unique accepted entries](dataTable/data_table.html?path=../output.tables/title_accepted.csv): `r length(unique(df[[field]]))`
-   [Unique discarded entries in original data](dataTable/data_table.html?path=../output.tables/title_discarded.csv) (excluding NA cases): `r as.vector(countLines(file_discarded) - 1)`
