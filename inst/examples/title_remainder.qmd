---
title_remainder : "Remainder of title"
...
[Unique accepted entries (1809-1917)](dataTable/data_table.html?path=https://a3s.fi/swift/v1/AUTH_3c0ccb602fa24298a6fe3ae224ca022f/fennica-container/output.tables/title_remainder_remainder_accepted_19.csv): `r length(unique(df_19[[field]]))`
...
### title_remainder Length Over Time (1809-1917)
...
ggplot(df2, aes(x = publication_year, y = title_remainder_length)) +
  ...
  scale_x_continuous(
    ...
    labels = as.character(seq(1809, 1920, by = 20))
  ) +
  labs(x = "Publication Year", y = "Remainder of Title Length") +
  theme_minimal()
```

### title_remainder Word Count (1809-1917)
