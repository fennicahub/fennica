...
description: "Statistics about the uncontrolled articles in the archives"
---
...
```{r}
#| label = "summarytitle-uncontrolled",
#| echo = FALSE,
#| message = FALSE,
#| warning = FALSE,
#| fig.width = 8,
...
```{r}
#| label = "uniquetitles-uncontrolled",
#| echo = FALSE,
#| message = FALSE,
#| warning = FALSE,
#| fig.width = 8,
