...
[Unique languages](dataTable/data_table.html?path=https://a3s.fi/swift/v1/AUTH_3c0ccb602fa24298a6fe3ae224ca022f/fennica-container/output.tables/language_accepted.csv):  `r length(unique(unlist(strsplit(as.character(df$languages), ";"))))-1` 
...
[Unique languages](dataTable/data_table.html?path=https://a3s.fi/swift/v1/AUTH_3c0ccb602fa24298a6fe3ae224ca022f/fennica-container/output.tables/language_accepted_19.csv): `r length(unique(unlist(strsplit(as.character(df_19$languages), ";"))))-1`
