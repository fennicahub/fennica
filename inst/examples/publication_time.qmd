...
Main function for harmonizing temporal data: [polish_years.R](https://github.com/fennicahub/fennica/blob/master/man/polish_years.Rd)

Script to polish publication time field: [publication_time.R](https://github.com/fennicahub/fennica/blob/master/inst/examples/publication_time.R)

Script to render publication time field: [publication_time.qmd](https://github.com/fennicahub/fennica/blob/master/inst/examples/publication_time.qmd)
